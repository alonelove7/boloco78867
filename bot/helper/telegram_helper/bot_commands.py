...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = getCommand(f'UNZIP_COMMAND', f'unzip121mirror{CMD_SUFFIX}'), f'u12zm{CMD_SUFFIX}'
        self.ZipMirrorCommand = getCommand(f'ZIP_COMMAND', f'zipm21irror{CMD_SUFFIX}'), f'z21m{CMD_SUFFIX}'
        self.LeechCommand = getCommand(f'LEECH_COMMAND', f'leech{CMD_SUFFIX}'), f'l{CMD_SUFFIX}'
        self.UnzipLeechCommand = getCommand(f'UNZIPLEECH_COMMAND', f'unz12ipleech{CMD_SUFFIX}'), f'u12zl{CMD_SUFFIX}'
        self.ZipLeechCommand = getCommand(f'ZIPLEECH_COMMAND', f'zip12leech{CMD_SUFFIX}'), f'z12l{CMD_SUFFIX}'
        ...
        self.QbUnzipMirrorCommand = getCommand(f'QBUNZIP_COMMAND', f'qbu12nzipmirror{CMD_SUFFIX}'), f'qu12zm{CMD_SUFFIX}'
        self.QbZipMirrorCommand = getCommand(f'QBZIP_COMMAND', f'qbzipm12irror{CMD_SUFFIX}'), f'qz12m{CMD_SUFFIX}'
        self.QbLeechCommand = getCommand(f'QBLEECH_COMMAND', f'qbleech{CMD_SUFFIX}'), f'ql{CMD_SUFFIX}'
        self.QbUnzipLeechCommand = getCommand(f'QBZIPLEECH_COMMAND', f'qbun12zipleech{CMD_SUFFIX}'), f'quz12l{CMD_SUFFIX}'
        self.QbZipLeechCommand = getCommand(f'QBUNZIPLEECH_COMMAND', f'qbzipl12eech{CMD_SUFFIX}'), f'q12zl{CMD_SUFFIX}'
        self.ScrapeCommand = getCommand(f'SCRAPE_COMMAND', f'scrape{CMD_SUFFIX}'), f'sm{CMD_SUFFIX}'
        self.YtdlCommand =  getCommand(f'YTDL_COMMAND', f'watch{CMD_SUFFIX}'), f'w{CMD_SUFFIX}'
        self.YtdlZipCommand = getCommand(f'YTDLZIP_COMMAND', f'yt45dlzip{CMD_SUFFIX}'), f'y54z{CMD_SUFFIX}'
        self.YtdlLeechCommand = getCommand(f'YTDLLEECH_COMMAND',  f'leechwatch{CMD_SUFFIX}'), f'lw{CMD_SUFFIX}'
        self.YtdlZipLeechCommand = getCommand(f'YTDLZIPLEECH_COMMAND', f'ytdlgyjzipleech{CMD_SUFFIX}'), f'ygyjzl{CMD_SUFFIX}'
